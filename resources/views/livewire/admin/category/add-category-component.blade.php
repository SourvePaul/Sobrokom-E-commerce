            ...
            <div class="page-title-wrapper">
                ...
                <div class="breadcrumb-list">
                    <ul>
                        ...
                        <li class="breadcrumb-link active">Category Form</li>
                    </ul>
                </div>
            </div>
        </div>
                            ...
                            <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-xl-6 col-lg-6 col-md-12 col-sm-12 col-12">
                                        ...
                                        {{-- ImagePreview --}}
                                        @if($logo)
                                            <img src="{{$logo->temporaryUrl()}}" width="120px" alt="">
                                        @endif
                                    </div>
                                </div>
                                        ...
                                        <td class="relative ">
                                            ...
                                            <div class="action-option ">
                                                <ul>
                                                    ...
                                                    <li>
                                                        <a href="#" onclick="confirm('Are tou sure, want to delete this category!.') || event.stopImmediatePropagation()" wire:click.prevent="deleteCategory('{{$category->id}}')"><i class="fa fa-trash-alt mr-2 "></i>Delete</a>
                                                    </li>
                                                </ul>
                                            </div>
                                        </td>
