            ...
            <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                <div class="card">
                    <div class="card-header">
                        <p class="card-desc"> New Coupon </p>
                    </div>
                    <div class="card-body">
                        <form class="separate-form"  wire:submit.prevent="addCoupon">
                            <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                                ...
                                <div class="row">
                                    <div class="col-xl-6 col-lg-6 col-md-12 col-sm-12 col-12">
                                        <div class="form-group">
                                            ...
                                            <input class="form-control" type="text" placeholder="Enter Coupon Name" id="member-name" name="name" wire:model="name" >
                                    ...
                                    <div class="col-xl-6 col-lg-6 col-md-12 col-sm-12 col-12">
                                        <div class="form-group">
                                            ...
                                            <input class="form-control" type="number" placeholder="Enter Coupon Value" id="member-value" name="coupon_value" wire:model="coupon_value" >
                                    ...
                                    <div class="col-xl-6 col-lg-6 col-md-12 col-sm-12 col-12">
                                        <div class="form-group">
                                            ...
                                            <input class="form-control" type="number" placeholder="Enter Cart Value" id="member-cart_value" name="cart_value" wire:model="cart_value" >
                                    ...
                                    <div class="col-xl-6 col-lg-6 col-md-12 col-sm-12 col-12">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" placeholder="2023-MM-DD 11:59:00.." name="end" id="end" wire:model="end">
