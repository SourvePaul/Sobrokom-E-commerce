                ...
                <div class="row wow fadeIn animated">
                    <div class="col-lg-3 col-md-6">
                        <div class="blog-card border-radius-10 overflow-hidden text-center">
                            <img src="{{ asset('assets/images/avatar-1.jpg') }}" alt="" class="border-radius-10 mb-30 hover-up">
                            ...
                            <div class="mobile-social-icon wow fadeIn animated mb-sm-5 mb-md-0 animated">
                                <a href="#" style=" float:left; width:20px!important; margin-left: 95px;"><img src="{{ asset('assets/images/icons/icon-facebook.svg') }}" alt=""></a>
                                <a href="#" style=" float:left; width:20px!important; "><img src="{{ asset('assets/images/icons/icon-twitter.svg') }}" alt=""></a>
                                <a href="#" style=" float:left; width:20px!important; "><img src="{{ asset('assets/images/icons/icon-instagram.svg') }}" alt=""></a>
                                <a href="#" style=" float:left; width:20px!important;"><img src="{{ asset('assets/images/icons/icon-pinterest.svg') }}" alt=""></a>
                            </div>
                        </div>
                    </div>
                    <!--col-->
                    <div class="col-lg-3 col-md-6">
                        <div class="blog-card border-radius-10 overflow-hidden text-center">
                            <img src="{{ asset('assets/images/avatar-2.jpg') }}" alt="" class="border-radius-10 mb-30 hover-up">
                    ...
                    <div class="col-lg-3 col-md-6">
                        <div class="blog-card border-radius-10 overflow-hidden text-center">
                            <img src="{{ asset('assets/images/avatar-3.jpg') }}" alt="" class="border-radius-10 mb-30 hover-up">
                    ...
                    <div class="col-lg-3 col-md-6">
                        <div class="blog-card border-radius-10 overflow-hidden text-center">
                            <img src="{{ asset('assets/images/avatar-4.jpg') }}" alt="" class="border-radius-10 mb-30 hover-up">
        ...
        <div class="container">
            ...
            <div class="row">
                <div class="col-md-4 text-center mb-md-0 mb-4">
                    <img class="btn-shadow-brand hover-up border-radius-10 bg-brand-muted wow fadeIn animated" src="{{ asset('assets/images/company-1.jpg') }}" alt="">
                ...
                <div class="col-md-4 text-center mb-md-0 mb-4">
                    <img class="btn-shadow-brand hover-up border-radius-10 bg-brand-muted wow fadeIn animated" src="{{ asset('assets/images/company-2.jpg') }}" alt="">
                ...
                <div class="col-md-4 text-center">
                    <img class="btn-shadow-brand hover-up border-radius-10 bg-brand-muted wow fadeIn animated" src="{{ asset('assets/images/company-3.jpg') }}" alt="">
        ...
        <div class="container pt-25">
            ...
            <div class="row align-items-center">
                <div class="col-md-6 col-lg-4">
                    <div class="hero-card box-shadow-outer-6 wow fadeIn animated mb-30 hover-up d-flex">
                        <div class="hero-card-icon icon-left-2 hover-up ">
                            <img class="btn-shadow-brand hover-up border-radius-5 bg-brand-muted" src="{{ asset('assets/images/avatar-1.jpg') }}" alt="">
                        </div>
                        <div class="pl-30">
                ...
                <div class="col-md-6 col-lg-4">
                    <div class="hero-card box-shadow-outer-6 wow fadeIn animated mb-30 hover-up d-flex">
                        <div class="hero-card-icon icon-left-2 hover-up ">
                            <img class="btn-shadow-brand hover-up border-radius-5 bg-brand-muted" src="{{ asset('assets/images/avatar-3.jpg') }}" alt="">
                        </div>
                        <div class="pl-30">
                            <h5 class="mb-5 fw-500">
                                B.Gates
                ...
                <div class="col-md-6 col-lg-4">
                    <div class="hero-card box-shadow-outer-6 wow fadeIn animated mb-30 hover-up d-flex">
                        <div class="hero-card-icon icon-left-2 hover-up ">
                            <img class="btn-shadow-brand hover-up border-radius-5 bg-brand-muted" src="{{ asset('assets/images/avatar-2.jpg') }}" alt="">
                        </div>
                        <div class="pl-30">
                            <h5 class="mb-5 fw-500">
                                B. Meyers
                ...
                <div class="col-md-6 col-lg-4">
                    <div class="hero-card box-shadow-outer-6 wow fadeIn animated mb-30 hover-up d-flex">
                        <div class="hero-card-icon icon-left-2 hover-up ">
                            <img class="btn-shadow-brand hover-up border-radius-5 bg-brand-muted" src="{{ asset('assets/images/avatar-4.jpg') }}" alt="">
                        </div>
                        <div class="pl-30">
                            <h5 class="mb-5 fw-500">
                                J. Bezos
                ...
                <div class="col-md-6 col-lg-4">
                    <div class="hero-card box-shadow-outer-6 wow fadeIn animated mb-30 hover-up d-flex">
                        <div class="hero-card-icon icon-left-2 hover-up ">
                            <img class="btn-shadow-brand hover-up border-radius-5 bg-brand-muted" src="{{ asset('assets/images/avatar-5.jpg') }}" alt="">
                        </div>
                        <div class="pl-30">
                            <h5 class="mb-5 fw-500">
                                B.Gates
