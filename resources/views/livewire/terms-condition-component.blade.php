                ...
                <div class="col-lg-9">
                    <div class="single-page pr-30 mb-lg-0 mb-sm-5">
                        ...
                        <figure class="single-thumbnail">
                            <img src="{{ asset('assets/imgs/blog/blog-10.jpg') }}" alt="">
                        </figure>
                        <div class="single-content">
                            <p> Please read these Terms of Service (“Terms”, “Terms of Service”) carefully before using
                                the https://Sobrokom.com website (the “Service”) operated by Sobrokom (“us”, “we”, or “our”).
                            </p>
                            ...
                            <ol>
                                ...
                                <li>Members are granted a time-limited, non-exclusive, revocable, nontransferable, and
                                    ...
                                    the purchase.</li>
                                <li>The portion of the online course corresponding to the purchase will be available to
                                    the Member as long as the course is maintained by the Company, which will be a
                                    minimum of one year after Member’s purchase.</li>
                                <li>The videos in the course are provided as a video stream and are not downloadable.
                                </li>
                                <li>By agreeing to grant such access, the Company does not obligate itself to maintain
                                    the course, or to maintain it in its present form.</li>
                            </ol>
                            <h4>Links To Other Web Sites</h4>
                            <p>Our Service may contain links to third-party web sites or services that are not owned or
                                controlled by Sobrokom.</p>
                            <p>Sobrokom has no control over, and assumes no responsibility for, the content, privacy
                                policies, or practices of any third party web sites or services. You further acknowledge
                                and agree that Sobrokom shall not be responsible or liable, directly or indirectly, for any
                            ...
                            <h4>Contact Us</h4>
                            <p>If you have any questions about these Terms, please <a href="page-contact.html">contact
                                    us</a>.</p>
                        </div>
                    </div>
                </div>
                            ...
                            <div class="post-block-list post-module-1 post-module-5">
                                <ul>
                                    <li class="cat-item cat-item-2">
                                        <a href="blog-category-list.html">Beauty</a> (3)
                                    </li>
                                    <li class="cat-item cat-item-3">
                                        <a href="blog-category-list.html">Book</a> (6)</li>
                                    <li class="cat-item cat-item-4">
                                        <a href="blog-category-list.html">Design</a> (4)
                                    </li>
                                    <li class="cat-item cat-item-5">
                                        <a href="blog-category-list.html">Fashion</a> (3)
                                    </li>
                                    <li class="cat-item cat-item-6">
                                        <a href="blog-category-list.html">Lifestyle</a> (6)
                                    </li>
                                    <li class="cat-item cat-item-7">
                                        <a href="blog-category-list.html">Travel</a> (2)
                                    </li>
                                </ul>
                            </div>
                        </div>
                        ...
                        <div class="sidebar-widget widget_alitheme_lastpost mb-20">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6 col-sm-6 sm-grid-content mb-30">
                                    ...
                                    <div class="post-content media-body">
                                        <h6 class="post-title mb-10 text-limit-2-row">Water Partners With Rag &amp; Bone
                                            To Consume</h6>
                                        <div class="entry-meta meta-13 font-xxs color-grey">
                                            <span class="post-on mr-10">25 April</span>
                                            <span class="hit-count has-dot ">126k Views</span>
