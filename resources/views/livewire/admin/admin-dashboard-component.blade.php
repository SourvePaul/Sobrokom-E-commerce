                ...
                <div class="breadcrumb-list">
                    <ul>
                        <li class="breadcrumb-link">
                            <a href="{{route('admin.dashboard')}}"><i class="fas fa-home mr-2"></i>Dashboard</a>
                        </li>
            ...
            <div class="card ad-info-card">
                <div class="card-body dd-flex align-items-center">
                    ...
                    <div class="icon-info-text">
                        ...
                        <h4 class="ad-card-title">{{$users->count()}}</h4>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="col-xl-3 col-lg-4 col-md-6">
            <div class="card ad-info-card">
                <div class="card-body dd-flex align-items-center">
                    ...
                    <div class="icon-info-text">
                        <h5 class="ad-title">Total Orders</h5>
                        <h4 class="ad-card-title">{{$orders->count()}}</h4>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="card ad-info-card">
                <div class="card-body dd-flex align-items-center">
                    ...
                    <div class="icon-info-text">
                        ...
                        <h4 class="ad-card-title">{{number_format($sale, 2)}}</h4>
                    </div>
                </div>
            </div>
        </div>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <span class="img-thumb ">
                                                    <img src="{{ asset('admin/assets/images/table/1.jpg') }} " alt=" ">
                                            ...
                                            <td>&#2547; {{$order->total}}</td>
                                            <td>
                                                <label class="mb-0 badge badge-primary" title="" data-original-title="Pending">{{$order->status}}</label>
                                            </td>
                                            <td>
                                                <span class="img-thumb">
