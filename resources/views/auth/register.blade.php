                                    ...
                                    <div class="padding_eight_all bg-white">
                                        ...
                                        <form method="POST" action="{{ route('register') }}">
                                            ...
                                            <div class="login_footer form-group">
                                                ...
                                                <a href="{{ route('privacy-policy')}}"><i class="fa fa-book mr-5 text-muted"></i>Learn more</a>
                                            </div>
                                            <div class="form-group">
                                        ...
                                        <div class="text-muted text-center">Already have an account? <a href="{{ route('login') }}" style="color: #c60038;">Sign in now</a></div>
                                    </div>
                                </div>
                            </div>
                        </div>
