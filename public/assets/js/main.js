(function ($) {
    ...
    $('.product-slider-active-1').slick({
        ...
        dots: false,
        arrows: true,
        prevArrow: '<span class="pro-icon-1-prev"><i class="fa fa-angle-small-left"></i></span>',
        nextArrow: '<span class="pro-icon-1-next"><i class="fa fa-angle-small-right"></i></span>',
        responsive: [
            {
                breakpoint: 1199,
                settings: {
   ...
   /*---------------------
    ...
    $offCanvasNavSubMenu.parent().prepend('<span class="menu-expand"><i class="fa fa-angle-small-down"></i></span>');
