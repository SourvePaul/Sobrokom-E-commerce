...
<head>
    ...
    <link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/noUiSlider/14.7.0/nouislider.min.css" integrity="sha512-40vN6DdyQoxRJCw0k1EUwZfTT1cwkOLKpP8K8125hy9iF4fi8gPpWZp60qKC6MYAFaond8yQds7cTMVU8eMbgA==" crossorigin="anonymous" referrerpolicy="no-referrer" />

    <link href="https://cdnjs.cloudflare.com/ajax/libs/bootstrap-datatimepicker/4.17.47/css/bootstrap-daratimepicker.min.css" rel="stylesheet" />
...
<body>
                    ...
                    <div class="header-controls">
                        ...
                        <div class="cart-wrapper header-links">
							...
							<div class="of-notification-comment">
								...
								<div class="of-nt-flex">
									<div class="of-nt-img">
										<img src="{{asset('admin/assets/images/product2.png')}}" alt=""/>
									</div>
								...
								<div class="of-nt-flex">
									<div class="of-nt-img">
										<img src="{{asset('admin/assets/images/product3.png')}}" alt=""/>
									</div>
									<div class="of-nt-cmnt">
										<p>Wooden Sofa<span>
										<svg xmlns="http://www.w3.org/2000/svg" width="9px" height="8px">
								...
								<div class="of-nt-flex">
									<div class="of-nt-img">
										<img src="{{asset('admin/assets/images/product.png')}}" alt=""/>
									</div>
									<div class="of-nt-cmnt">
										<p>Dining Chair<span>
										<svg xmlns="http://www.w3.org/2000/svg" width="9px" height="8px">
                        ...
                        <div class="user-info-wrapper header-links">
                            <a href="javascript:void(0);" class="user-info">
                                <img src="{{asset('admin/assets/images/user.jpg')}}" alt="" class="user-img">
        ...
        <div class="slide-setting-holder">
            ...
            <div class="setting-box-body">
				<div class="sd-light-vs"> 
					<a href="../splashdash-admin-template/index.html">
						Light Version
						<img src="{{asset('admin/assets/images/light.png')}}" alt=""/>
					</a>
				</div>
				<div class="sd-light-vs"> 
					<a href="index.html">
						dark Version
						<img src="{{asset('admin/assets/images/dark.png')}}" alt=""/>
					</a>
				</div>
            </div>
    ...
    <script src="https://cdnjs.cloudflare.com/ajax/libs/noUiSlider/14.7.0/nouislider.min.js" integrity="sha512-jWNpWAWx868/GZV4Qsce63q5jxx/rpWnw812vh0RE+SBIo/mmepwOSQkY2eVQnMuE28pzUE07ux0a5sJX91g8A==" crossorigin="anonymous" referrerpolicy="no-referrer"></script>

    <script src="https://cdnjs.cloudflare.com/ajax/libs/bootstrap-datatimepicker/4.17.47/js/bootstrap-daratimepicker.min.js"></script>
    <script src="https://cdnjs.cloudflare.com/ajax/libs/moment.js/2.29.1/moment.min.js"></script>
    {{-- <script src="https://cdnjs.cloudflare.com/ajax/libs/ckeditor/4.14.1/ckeditor.js" integrity="sha512-P4rrEImABBYtBFdmrFPqF8rjh8iiRiupfQ4KLrBCL8dAivLiM2nh+1bJQeMb2ZglmIlGZdfTtgGdXH6H/hGVeg==" crossorigin="anonymous" referrerpolicy="no-referrer"></script> --}}
