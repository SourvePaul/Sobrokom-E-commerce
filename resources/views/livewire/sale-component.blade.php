                                ...
                                <div class="product-cart-wrap mb-30">
                                    <div class="product-img-action-wrap">
                                        <div class="product-img product-img-zoom">
                                            <a href="{{route('product-detail',['slug'=>$product->slug])}}">
                                                <img class="default-img" src="{{ asset('assets/images/product')}}/{{$product->front_image}}"
                                                    alt="{{$product->slug}}">
                                                <img class="hover-img" src="{{ asset('assets/images/product')}}/{{$product->back_image}}"
                                                    alt="{{$product->slug}}">
                                            </a>
                                        </div>
                                        <div class="product-action-1">
                                            ...
                                            <a aria-label="Add To Wishlist" class="action-btn hover-up" href="#" wire:click.prevent="wishlist('{{$product->id}}', '{{$product->name}}', {{$product->sale_price}})">
                                                <i class="fa fa-heart"></i>
                                            </a>
                                            <a aria-label="Compare" class="action-btn hover-up" href="#" wire:click.prevent="compare('{{$product->id}}', '{{$product->name}}', '{{$product->sale_price}}', {{$product->stock}})">
                                    ...
                                    <div class="product-content-wrap">
                                        ...
                                        <div class="product-action-1 show">
                                            <a aria-label="Add To Cart" class="action-btn hover-up" href="#" wire:click.prevent="store('{{$product->id}}', '{{$product->name}}', {{$product->sale_price}})">
                                                    ...
                                                    <div class="detail-info">
                                                        ...
                                                        <div class="detail-extralink">
                                                            <div class="product-extra-link2">
                                                                ...
                                                                <a aria-label="Compare" class="action-btn hover-up" href="#" wire:click.prevent="compare('{{$product->id}}', '{{$product->name}}', '{{$product->sale_price}}', {{$product->stock}})"><i class="fa fa-random"></i></a>
                                                            </div>
                                                        </div>
