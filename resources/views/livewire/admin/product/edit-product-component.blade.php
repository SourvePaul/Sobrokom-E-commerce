        ...
        <div class="row">
            <div class="col-md-12">
                <div class="card">
                    ...
                    <div class="card-body">
                        <form action="" enctype="multipart/form-data" wire:submit.prevent="editProduct">
                            <div class="row">
                                <div class="col-md-6">
                                ...
                                <div class="col-md-6 mt-4">
                                    <div class="form-group">
                                        ...
                                        <div wire:loading wire:target="new_front_image" wire:key="new_front_image"><i class="fa fa-spinner fa-spin mt-2 ml-2"></i>Uploading</div>
            
                                        {{-- ImagePreview --}}
                                        @if($new_front_image)
                                            <img src="{{$new_front_image->temporaryUrl()}}" width="120px" alt="">
                                        @else
                                            <img src="{{asset('assets/images/product')}}/{{$front_image}}" width="120px" alt="">
                                        @endif
                                    </div>
                                </div>
                                <div class="col-md-6 mt-4">
                                    <div class="form-group">
                                        ...
                                        <div wire:loading wire:target="new_back_image" wire:key="new_back_image"><i class="fa fa-spinner fa-spin mt-2 ml-2"></i>Uploading</div>
            
                                        {{-- ImagePreview --}}
                                        @if($new_back_image)
                                            <img src="{{$new_back_image->temporaryUrl()}}" width="120px" alt="">
                                        @else
                                            <img src="{{asset('assets/images/product')}}/{{$back_image}}" width="120px" alt="">
                                        @endif
                                    </div>
                                </div>
                                <div class="col-md-12 mt-4">
                                    <div class="form-group">
                                        ...
                                        <input type="file" multiple name="new_gallery" id="new_gallery" class="form-control" wire:model="new_gallery" />
                                        
                                        @if($new_gallery)
                                        @foreach($new_gallery as $image)
                                            <div wire:loading wire:target="new_gallery" wire:key="new_gallery"><i class="fa fa-spinner fa-spin mt-2 ml-2"></i>Uploading</div>
                                        ...
                                        @else
                                            ...
                                            @foreach($images as $image)
                                                @if($image)
                                                    <img src="{{asset('assets/images/product/gallery')}}/{{$image}}" width="120" alt="">
                                                @endif
                                            @endforeach
                                        @endif
                                    </div>
