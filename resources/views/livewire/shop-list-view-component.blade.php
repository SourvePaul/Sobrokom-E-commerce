                            ...
                            <div class="product-cart-wrap">
                                ...
                                <div class="product-content-wrap">
                                    ...
                                    <div class="product-action-1 show">
                                        <a aria-label="Buy now" class="action-btn hover-up" href="#" wire:click.prevent="store('{{$product->id}}', '{{$product->name}}', {{$product->price}})">
                                                    ...
                                                    <div class="social-icons single-share">
                                                        <ul class="text-grey-5 d-inline-block">
                                                            ...
                                                            <li class="social-facebook">
                                                                <a href="#"><img src="{{ asset('assets/images/icon-facebook.svg') }}" alt="">
                                                                </a>
                                                            </li>
                                                            <li class="social-twitter">
                                                                <a href="#"><img src="{{ asset('assets/images/icon-twitter.svg') }}" alt="">
                                                                </a>
                                                            </li>
                                                            <li class="social-instagram">
                                                                <a href="#"><img src="{{ asset('assets/images/icon-instagram.svg') }}" alt="">
                                                                </a>
                                                            </li>
                                                            <li class="social-linkedin">
                                                                <a href="#"><img src="{{ asset('assets/images/icon-pinterest.svg') }}" alt="">
                                                                </a>
                                                            </li>
                                                        </ul>
                                                    </div>
